...
| Phase 2   | Account, credentials and revocable sessions | Permanent self-service access for Client, Professional and Manager.                   |
| Phase 3   | Client and Professional profiles            | Private verification, public profiles, work-right and skills workflows.               |
...
| Phase 8   | Financial ledger and payout onboarding      | Currency-aware, auditable billing and earnings states.                                |
...
| Submit dispute request          | Yes               | Yes                        | Yes                  |
...
This framework should be approved before implementation of marketplace
search, ranking, reviews, financial execution or automated account
enforcement. Deviations must be documented, risk-assessed and approved
by the Product Owner and the relevant Trust, Accessibility, Security or
Legal owner.
