...
export const ROLE_CAPABILITIES = Object.freeze({
  manager: Object.freeze({ manageProjects: true, startProject: true, viewClients: true, viewInternalFinancials: true, viewProjectAudit: true }),
  client: Object.freeze({ manageProjects: false, startProject: false, viewClients: false, viewInternalFinancials: false, viewProjectAudit: false }),
  team_member: Object.freeze({ manageProjects: false, startProject: false, viewClients: false, viewInternalFinancials: false, viewProjectAudit: false }),
});
